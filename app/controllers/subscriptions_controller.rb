...
class SubscriptionsController < ApplicationController
  ...
  before_action :validate_user_paid_plan, only: %i[index payment_info]
  ...
  #     params[:plan_id] = STRIPEPLANS[params[:plan_id]] if STRIPEPLANS[params[:plan_id]]
  #     params[:plan_id] = NEWSTRIPEPLANS[params[:plan_id]] if NEWSTRIPEPLANS[params[:plan_id]]
