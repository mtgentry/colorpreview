$(document).ready(function(){
  if($('#main_red-aesthetic').length == 0) return false
  var body = $('body');
  ...
  function changeColor() {
    for (var colorLoop = 0; colorLoop<20; colorLoop++) {
      ...
      colors[0] = colorsets["triad"]["w_step0"][colorLoop][0];
      colors[1] = colorsets["triad"]["w_step0"][colorLoop][1];
      colors[2] = colorsets["triad"]["w_step0"][colorLoop][2] || "";
      colors[3] = colorsets["triad"]["w_step0"][colorLoop][3] || "";        
      color_len = colorsets["triad"]["w_step0"][colorLoop].length;
      
      if (colorLoop == 0) { // 9 = center of 0-19 range
        var t = colorauthor["triad"] && colorauthor["triad"]["w_step0"] ? colorauthor["triad"]["w_step0"][colorLoop] : ''
        color_page_elements(colors[0],colors[1],colors[2],colors[3], t);
      }
      if (colorLoop <20) {
        if (colorauthor["triad"] && colorauthor["triad"]["w_step0"] && colorauthor["triad"]["w_step0"][colorLoop]) {
